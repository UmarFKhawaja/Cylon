...
import { OpenSquareBracketRule } from './OpenSquareBracketRule';

describe('OpenSquareBracketRule', (): void => {
  it('should match a open square bracket character', (): void => {
    const input: Input = Input.fromText('[');

    const result: Result = applyRule(input, OpenSquareBracketRule);
